...
public class GeneradorNormalNombres {
	...
	public GeneradorNormalNombres(String archivo) {
		tn = TAM_DEF_CAB;
		restar = 0;
		local = false;
	...
	public GeneradorNormalNombres(String archivo, int tam, int rest) {
	...
	// resta
	public GeneradorNormalNombres(int tam, int rest) {
		cambiarProporcion(tam, rest);
		tn = tam;
		restar = rest;
		local = true;
