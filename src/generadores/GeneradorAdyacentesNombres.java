...
public class GeneradorAdyacentesNombres {
	...
	public GeneradorAdyacentesNombres(String archivo) {
		tn = TAM_DEF_CAB;
		restar = 0;
		local = false;
	...
	public GeneradorAdyacentesNombres(String archivo, int tam, int rest) {
	...
	// .jar)
	public GeneradorAdyacentesNombres() {
		tn = TAM_DEF_CAB;
		restar = 0;
		local = true;
	...
	// resta
	public GeneradorAdyacentesNombres(int tam, int rest) {
		cambiarProporcion(tam, rest);
		tn = tam;
		restar = rest;
		local = true;
